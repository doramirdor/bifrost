...
func TestDefaultSemanticExemplars(t *testing.T) {
	tiers := []struct {
		name   string
		values []string
	}{
		{name: TierSimple, values: defaultSimpleExemplars},
		{name: TierMedium, values: defaultMediumExemplars},
		{name: TierComplex, values: defaultComplexExemplars},
	}
...
func TestDefaultEditableKeywordConfigFitsSemanticValidationLimits(t *testing.T) {
