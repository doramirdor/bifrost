...
// binding. NUL-separated so distinct tuples can never collide.
...
// eviction predicates. ok is false for a key that is not three NUL-joined
// parts (impossible for keys this package builds).
